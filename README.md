...
| 5 | RFC-0002: Projection Engine | 📝 Draft |
| 6 | Real AI provider | ⏳ Pending |
| 7 | Remaining kernel capabilities | ⏳ Pending |
...
| [RFC-0002](RFC/RFC-0002-projection-engine.md) | Projection Engine | Draft |
